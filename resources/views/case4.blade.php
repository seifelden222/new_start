...
<head>
    ...
    <title>بداية جديدة - حالة فاطمة محمد</title>
...
<body class="bg-slate-50 min-h-screen flex flex-col">
    ...
    <main class="flex-grow max-w-6xl mx-auto w-full p-6 my-10">
        <div class="flex gap-2 text-sm font-bold text-slate-400 mb-8">
            ...
            <span>/</span>
            <span class="text-slate-800">مشروع تمكين أسر</span>
        </div>

        <div class="flex flex-col lg:flex-row gap-10">
            <div class="lg:w-1/3">
                <div class="bg-white p-4 rounded-[2.5rem] shadow-xl shadow-slate-200/60 border border-white">
                    <img src="assets/img/mam2.jpg" alt="فاطمة محمد" class="w-full h-[400px] object-cover rounded-[2rem] shadow-inner">
                    <div class="mt-6 space-y-4 px-2">
                        <div class="flex justify-between items-center">
                            <span class="bg-blue-50 text-blue-600 px-4 py-1 rounded-full text-xs font-black">دعم مشاريع</span>
                            <span class="text-slate-400 font-bold text-sm">رقم الحالة: #6612</span>
                        </div>
                        <h1 class="text-2xl font-black text-slate-800">فاطمة محمد (37 سنة)</h1>
            ...
            <div class="lg:w-2/3 space-y-8">
                <div class="bg-white p-10 rounded-[2.5rem] shadow-xl shadow-slate-200/60 border border-white relative overflow-hidden">
                    <div class="absolute top-0 right-0 p-8 opacity-5">
                        <span class="material-symbols-outlined text-[120px]">storefront</span>
                    </div>
                    ...
                    <p class="text-slate-600 leading-[2.2] font-medium text-lg text-justify">
                        فاطمة أم لثلاثة أطفال، تسعى جاهدة لتوفير حياة كريمة لأسرتها من خلال مهاراتها في صناعة المشغولات اليدوية والتطريز. تحلم فاطمة بتأسيس مشروع صغير (مشغل منزلي) يوفر لها دخلاً مستداماً، لكنها تحتاج لرأس مال بسيط لشراء الأدوات والمواد الخام الأساسية لبدء إنتاجها وتسويقه.
                    </p>

                    <div class="mt-12 p-8 bg-slate-50 rounded-3xl border border-slate-100">
                        <div class="flex justify-between items-end mb-4">
                            <div>
                                <p class="text-slate-400 font-bold text-xs uppercase tracking-widest mb-1">تكلفة المشروع</p>
                                <p class="text-3xl font-black text-slate-800">8,000 <span class="text-sm">ج.م</span></p>
                            </div>
                            <div class="text-left">
                                <p class="text-blue-600 font-black text-xl">60%</p>
                                <p class="text-slate-400 font-bold text-[10px]">تم جمع 4,800 ج.م</p>
                            </div>
                        </div>
                        <div class="w-full bg-slate-200 rounded-full h-4 overflow-hidden">
                            <div class="progress-gradient h-full rounded-full shadow-lg shadow-blue-500/40" style="width: 60%"></div>
                        </div>
                    </div>
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <div class="bg-white p-6 rounded-3xl border border-slate-100 flex items-center gap-5">
                        <div class="w-14 h-14 bg-purple-50 text-purple-600 rounded-2xl flex-shrink-0 flex items-center justify-center">
                            <span class="material-symbols-outlined text-2xl">hardware</span>
                        </div>
                        <div class="min-w-0">
                            <p class="font-black text-slate-800 text-sm md:text-base">أدوات إنتاج</p>
                            <p class="text-[10px] text-slate-400 font-bold truncate">ماكينة خياطة ومعدات</p>
                        </div>
                    </div>
                    <div class="bg-white p-6 rounded-3xl border border-slate-100 flex items-center gap-5">
                        ...
                        <div class="min-w-0">
                            <p class="font-black text-slate-800 text-sm md:text-base">مواد خام</p>
                            <p class="text-[10px] text-slate-400 font-bold truncate">أقمشة وخيوط متنوعة</p>
                        </div>
                    </div>
                </div>
            </div>
        ...
        function shareCase() {
            if (navigator.share) {
                navigator.share({
                    ...
                    text: 'ساعد فاطمة في بدء مشروعها الصغير وتوفير حياة كريمة لأسرتها',
