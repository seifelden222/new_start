...
<body class="bg-background-light dark:bg-background-dark text-slate-900 dark:text-slate-100">
        ...
        <main class="flex-1 mr-64">
            ...
            <div class="p-8 max-w-7xl mx-auto space-y-8">
                ...
                <div class="bg-white dark:bg-slate-900 rounded-xl border border-slate-200 dark:border-slate-800 shadow-sm p-8">
                    <h2 class="text-3xl font-black mb-2 text-primary">أهلاً بكِ يا مي محمد 👋</h2>
                    ...
                    <div class="bg-white dark:bg-slate-900 rounded-xl border border-slate-200 dark:border-slate-800 shadow-sm p-6 hover:shadow-md transition-shadow">
                        <div class="flex items-center gap-4 mb-4">
                            ...
                            <div>
                                ...
                                <h3 class="text-2xl font-black text-slate-900 dark:text-white">2,450 <span class="text-sm text-slate-400">ج.م</span></h3>
                            </div>
                        </div>
                    ...
                    <div class="bg-white dark:bg-slate-900 rounded-xl border border-slate-200 dark:border-slate-800 shadow-sm p-6 hover:shadow-md transition-shadow">
                        <div class="flex items-center gap-4 mb-4">
                            ...
                            <div>
                                ...
                                <h3 class="text-2xl font-black text-emerald-600">15,800 <span class="text-sm text-slate-400">ج.م</span></h3>
                            </div>
                        </div>
                        <p class="text-xs text-emerald-600 font-bold">تم مساعدة 24 شخص ✓</p>
                    </div>
                    ...
                    <div class="bg-white dark:bg-slate-900 rounded-xl border border-slate-200 dark:border-slate-800 shadow-sm p-6 hover:shadow-md transition-shadow">
                        <div class="flex items-center gap-4 mb-4">
                            ...
                            <div>
                                ...
                                <h3 class="text-2xl font-black text-amber-500">1,240 <span class="text-sm text-slate-400">نقطة</span></h3>
                            </div>
                        </div>
    ...
    <script>
        ...
        document.addEventListener('DOMContentLoaded', function() {
            ...
            if (searchInput) {
                searchInput.addEventListener('input', function(e) {
                    ...
                    // البحث يعمل فعلياً في الصفحة
                });
            }
        });

        // Charge wallet functions
        ...
        function confirmCharge() {
            ...
            showToast(`✅ تم شحن المحفظة بمبلغ ${amount} ج.م عبر ${selectedPayment}`, 'success');
            closeChargeWallet();
        ...
        <div class="bg-white dark:bg-slate-900 rounded-2xl shadow-2xl w-full max-w-md mx-4" onclick="event.stopPropagation()">
            ...
            <div class="p-6">
                <div class="mb-6">
                    ...
                    <input type="number" id="chargeAmount" class="w-full px-4 py-3 bg-slate-50 dark:bg-slate-800 border border-slate-200 dark:border-slate-700 rounded-lg focus:ring-2 focus:ring-primary/50 focus:border-primary outline-none" placeholder="أدخل المبلغ">
                </div>
                <div class="mb-6">
