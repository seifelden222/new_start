...
<body class="bg-slate-50 min-h-screen flex flex-col antialiased">
  ...
  <main class="flex-grow py-12 px-4">
    <div class="max-w-4xl mx-auto">
      <div class="hero-gradient rounded-[2.5rem] p-10 md:p-16 mb-12 text-center relative overflow-hidden shadow-2xl">
      ...
      <div class="bg-white rounded-[2.5rem] p-8 md:p-14 shadow-xl border border-slate-100">
        ...
        <section class="mb-12">
          ...
          <p class="text-slate-600 font-medium leading-relaxed mb-6">نقوم بجمع البيانات التي تقدمها لنا مباشرة لضمان سير العملية الخيرية:</p>
        ...
        <section class="mb-12">
          ...
          <p class="text-slate-600 font-medium leading-relaxed mb-6">
            نستخدم تقنيات التشفير المتقدمة (SSL) ونقوم بتخزين البيانات في خوادم سحابية مؤمنة. الوصول إلى البيانات الشخصية يقتصر فقط على الموظفين المخولين لدراسة الحالات.
          </p>
        </section>

        <div class="mt-16 p-8 bg-slate-900 rounded-[2rem] text-center text-white relative overflow-hidden group">
          ...
          <a href="mailto:privacy@newbeginning.org" class="text-white font-black text-2xl hover:text-blue-400 transition underline underline-offset-8 decoration-blue-600">privacy@newbeginning.org</a>
        </div>
      </div>
    </div>
  </main>
