...
<head>
    ...
    <title>بداية جديدة - حالة أحمد سالم</title>
...
<body class="bg-slate-50 min-h-screen flex flex-col">
    ...
    <main class="flex-grow max-w-6xl mx-auto w-full p-6 my-10">
        <div class="flex gap-2 text-sm font-bold text-slate-400 mb-8">
            ...
            <span>/</span>
            <span class="text-slate-800">حالة طبية طارئة</span>
        </div>

        <div class="flex flex-col lg:flex-row gap-10">
            <div class="lg:w-1/3">
                <div class="bg-white p-4 rounded-[2.5rem] shadow-xl shadow-slate-200/60 border border-white">
                    <img src="assets/img/man6.jpg" alt="أحمد سالم" class="w-full h-[400px] object-cover rounded-[2rem] shadow-inner">
                    <div class="mt-6 space-y-4 px-2">
                        <div class="flex justify-between items-center">
                            ...
                            <span class="text-slate-400 font-bold text-sm">رقم الحالة: #7742</span>
                        </div>
                        <h1 class="text-2xl font-black text-slate-800">أحمد سالم (29 سنة)</h1>
            ...
            <div class="lg:w-2/3 space-y-8">
                <div class="bg-white p-10 rounded-[2.5rem] shadow-xl shadow-slate-200/60 border border-white relative overflow-hidden">
                    ...
                    <p class="text-slate-600 leading-[2.2] font-medium text-lg text-justify">
                        أحمد شاب في مقتبل العمر، يعاني من ثقب في القلب يحتاج إلى تدخل جراحي عاجل. تدهورت حالته الصحية مؤخراً مما منعه من ممارسة عمله البسيط كعامل يومية. التبرعات ستوجه بالكامل لتغطية تكاليف العملية الجراحية في مستشفى متخصص وتوفير الأدوية اللازمة لفترة الاستشفاء.
                    </p>

                    <div class="mt-12 p-8 bg-slate-50 rounded-3xl border border-slate-100">
                        <div class="flex justify-between items-end mb-4">
                            <div>
                                <p class="text-slate-400 font-bold text-xs uppercase tracking-widest mb-1">المبلغ المطلوب للعملية</p>
                                <p class="text-3xl font-black text-slate-800">45,000 <span class="text-sm">ج.م</span></p>
                            </div>
                            <div class="text-left">
                                <p class="text-blue-600 font-black text-xl">30%</p>
                                <p class="text-slate-400 font-bold text-[10px]">تم جمع 13,500 ج.م</p>
                            </div>
                        </div>
                        <div class="w-full bg-slate-200 rounded-full h-4 overflow-hidden">
                            <div class="progress-gradient h-full rounded-full shadow-lg shadow-blue-500/40" style="width: 30%"></div>
                        </div>
                    </div>
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <div class="bg-white p-6 rounded-3xl border border-slate-100 flex items-center gap-5">
                        <div class="w-14 h-14 bg-red-50 text-red-600 rounded-2xl flex items-center justify-center">
                            <span class="material-symbols-outlined">OR</span>
                        </div>
                        <div>
                            <p class="font-black text-slate-800">عملية جراحية</p>
                            <p class="text-xs text-slate-400 font-bold">تدخل عاجل في القلب</p>
                        </div>
                    </div>
                    <div class="bg-white p-6 rounded-3xl border border-slate-100 flex items-center gap-5">
                        ...
                        <div>
                            <p class="font-black text-slate-800">رعاية مركزة</p>
                            <p class="text-xs text-slate-400 font-bold">متابعة ما بعد الجراحة</p>
                        </div>
                    </div>
                </div>
            </div>
        ...
        function shareCase() {
            if (navigator.share) {
                navigator.share({
                    ...
                    text: 'ساعدونا في إنقاذ حياة أحمد سالم عبر منصة بداية جديدة',
