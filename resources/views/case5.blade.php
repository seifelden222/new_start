...
<head>
    ...
    <title>بداية جديدة - حالة إياد علي</title>
...
<body class="bg-slate-50 min-h-screen flex flex-col">
    ...
    <main class="flex-grow max-w-6xl mx-auto w-full p-6 my-10">
        <div class="flex gap-2 text-sm font-bold text-slate-400 mb-8">
            ...
            <span>/</span>
            <span class="text-slate-800">تأهيل وتدريب مهني</span>
        </div>

        <div class="flex flex-col lg:flex-row gap-10">
            <div class="lg:w-1/3">
                <div class="bg-white p-4 rounded-[2.5rem] shadow-xl shadow-slate-200/60 border border-white">
                    <img src="assets/img/man3.jpg" alt="إياد علي" class="w-full h-[400px] object-cover rounded-[2rem] shadow-inner">
                    <div class="mt-6 space-y-4 px-2">
                        <div class="flex justify-between items-center">
                            <span class="bg-blue-50 text-blue-600 px-4 py-1 rounded-full text-xs font-black">يتيم</span>
                            <span class="text-slate-400 font-bold text-sm">رقم الحالة: #5541</span>
                        </div>
                        <h1 class="text-2xl font-black text-slate-800">إياد علي (19 سنة)</h1>
            ...
            <div class="lg:w-2/3 space-y-8">
                <div class="bg-white p-10 rounded-[2.5rem] shadow-xl shadow-slate-200/60 border border-white relative overflow-hidden">
                    <div class="absolute top-0 right-0 p-8 opacity-5">
                        <span class="material-symbols-outlined text-[120px]">carpenter</span>
                    </div>
                    ...
                    <p class="text-slate-600 leading-[2.2] font-medium text-lg text-justify">
                        إياد شاب فقد والديه في سن مبكرة، لكنه لم يفقد الأمل في بناء مستقبله. يمتلك شغفاً كبيراً بتعلم حرفة النجارة والديكور ليتمكن من الاعتماد على نفسه وإعالة أسرته الصغيرة. يحتاج إياد لدعم مالي لتغطية تكاليف دورة تدريبية مكثفة وشراء حقيبة الأدوات الأساسية ليبدأ أولى خطواته في سوق العمل.
                    </p>

                    <div class="mt-12 p-8 bg-slate-50 rounded-3xl border border-slate-100">
                        <div class="flex justify-between items-end mb-4">
                            <div>
                                <p class="text-slate-400 font-bold text-xs uppercase tracking-widest mb-1">تكلفة التدريب</p>
                                <p class="text-3xl font-black text-slate-800">5,500 <span class="text-sm">ج.م</span></p>
                            </div>
                            <div class="text-left">
                                <p class="text-blue-600 font-black text-xl">85%</p>
                                <p class="text-slate-400 font-bold text-[10px]">تم جمع 4,675 ج.م</p>
                            </div>
                        </div>
                        <div class="w-full bg-slate-200 rounded-full h-4 overflow-hidden">
                            <div class="progress-gradient h-full rounded-full shadow-lg shadow-blue-500/40" style="width: 85%"></div>
                        </div>
                    </div>
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <div class="bg-white p-6 rounded-3xl border border-slate-100 flex items-center gap-5">
                        <div class="w-14 h-14 bg-orange-50 text-orange-600 rounded-2xl flex-shrink-0 flex items-center justify-center">
                            <span class="material-symbols-outlined text-2xl">history_edu</span>
                        </div>
                        <div class="min-w-0">
                            <p class="font-black text-slate-800 text-sm">دورة تدريبية</p>
                            <p class="text-[10px] text-slate-400 font-bold truncate">تعلم فنون النجارة</p>
                        </div>
                    </div>
                    <div class="bg-white p-6 rounded-3xl border border-slate-100 flex items-center gap-5">
                        ...
                        <div class="min-w-0">
                            <p class="font-black text-slate-800 text-sm">حقيبة أدوات</p>
                            <p class="text-[10px] text-slate-400 font-bold truncate">معدات العمل اليدوية</p>
                        </div>
                    </div>
                </div>
            </div>
        ...
        function shareCase() {
            if (navigator.share) {
                navigator.share({
                    ...
                    text: 'ساهم في بناء مستقبل إياد وتعليمه حرفة النجارة. شارك الحالة الآن!',
                ...
                alert('تم نسخ رابط حالة إياد بنجاح! يمكنك الآن لصقه ومشاركته لنشر الخير. 🔗');
            }
        }
