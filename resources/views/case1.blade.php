        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="flex items-center justify-between h-20">
                ...
                <div class="flex items-center gap-4">
                    <button
                        class="bg-blue-600 hover:bg-blue-700 text-white px-6 py-2.5 rounded-xl font-bold transition-all shadow-lg shadow-blue-500/20 active:scale-95 hidden sm:flex items-center gap-2">
        ...
        <div class="flex flex-col lg:flex-row gap-10">
            <div class="lg:w-1/3">
                <div class="bg-white p-4 rounded-[2.5rem] shadow-xl shadow-slate-200/60 border border-white">
                    <img src="assets/img/girl.jpg" alt="سالي محمد"
                        class="w-full h-[400px] object-cover rounded-[2rem] shadow-inner">
            ...
            <div class="lg:w-2/3 space-y-8">
                <div
                    class="bg-white p-10 rounded-[2.5rem] shadow-xl shadow-slate-200/60 border border-white relative overflow-hidden">
                    ...
                    <p class="text-slate-600 leading-[2.2] font-medium text-lg text-justify">
                        سالي طالبة في السنة الأخيرة بكلية الطب، واجهت ظروفاً صعبة بعد وفاة والدها. هي الآن مهددة بعدم
                        القدرة على دخول الامتحانات النهائية بسبب الرسوم الدراسية المتأخرة. سالي تطمح لتكون طبيبة تخدم
                        مجتمعها وترد الجميل لكل من وقف بجانبها.
                    </p>

                    <div class="mt-12 p-8 bg-slate-50 rounded-3xl border border-slate-100">
                        <div class="flex justify-between items-end mb-4">
                            <div>
                                <p class="text-slate-400 font-bold text-xs uppercase tracking-widest mb-1">المبلغ
                                    المطلوب</p>
                                <p class="text-3xl font-black text-slate-800">15,000 <span class="text-sm">ج.م</span>
                                </p>
                            </div>
                            <div class="text-left">
                        ...
                        <div class="w-full bg-slate-200 rounded-full h-4 overflow-hidden">
                            <div class="progress-gradient h-full rounded-full shadow-lg shadow-blue-500/40"
                                style="width: 70%"></div>
                        </div>
                    </div>
                    ...
                    <div class="mt-10 flex flex-col sm:flex-row gap-4">
                        <a href="{{ url('donation') }}"
                            class="flex-1 bg-blue-700 hover:bg-blue-800 text-white py-5 rounded-2xl font-black text-lg shadow-2xl shadow-blue-700/30 transition-all active:scale-[0.98] flex items-center justify-center gap-3">
                            <span class="material-symbols-outlined">volunteer_activism</span>
                            تبرع لهذه الحالة
                        </a>
                        <button onclick="shareCase()"
                            class="px-8 py-5 border-2 border-slate-100 rounded-2xl font-black text-slate-400 hover:bg-slate-50 transition-all flex items-center justify-center gap-3">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <div class="bg-white p-6 rounded-3xl border border-slate-100 flex items-center gap-5">
                        <div
                            class="w-14 h-14 bg-orange-100 text-orange-600 rounded-2xl flex-shrink-0 flex items-center justify-center">
                    ...
                    <div class="bg-white p-6 rounded-3xl border border-slate-100 flex items-center gap-5">
                        <div
                            class="w-14 h-14 bg-green-100 text-green-600 rounded-2xl flex-shrink-0 flex items-center justify-center">
