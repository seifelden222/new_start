...
<head>
    ...
    <title>بداية جديدة - حالة خالد يوسف</title>
...
<body class="bg-slate-50 min-h-screen flex flex-col">
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="flex items-center justify-between h-20">
                ...
                <nav class="hidden md:flex items-center gap-10">
                    ...
                    <a class="text-slate-300 hover:text-white font-medium transition-all relative after:content-[''] after:absolute after:w-0 after:h-0.5 after:bg-blue-500 after:bottom-[-4px] after:right-0 hover:after:w-full after:transition-all" href="caseslist.html">الحالات</a>
                    <a class="text-slate-300 hover:text-white font-medium transition-all relative after:content-[''] after:absolute after:w-0 after:h-0.5 after:bg-blue-500 after:bottom-[-4px] after:right-0 hover:after:w-full after:transition-all" href="donation.html">خدمتنا</a>
                    <a class="text-slate-300 hover:text-white font-medium transition-all relative after:content-[''] after:absolute after:w-0 after:h-0.5 after:bg-blue-500 after:bottom-[-4px] after:right-0 hover:after:w-full after:transition-all" href="aboutus.html">من نحن</a>
                </nav>
    ...
    <main class="flex-grow max-w-6xl mx-auto w-full p-6 my-10">
        <div class="flex gap-2 text-sm font-bold text-slate-400 mb-8">
            <a href="caseslist.html" class="hover:text-blue-600">قائمة الحالات</a>
            <span>/</span>
            <span class="text-slate-800">تأهيل صحي وعلاجي</span>
        </div>

        <div class="flex flex-col lg:flex-row gap-10">
            <div class="lg:w-1/3">
                <div class="bg-white p-4 rounded-[2.5rem] shadow-xl shadow-slate-200/60 border border-white">
                    <img src="assets/img/man.jpg" alt="خالد يوسف" class="w-full h-[400px] object-cover rounded-[2rem] shadow-inner">
                    <div class="mt-6 space-y-4 px-2">
                        <div class="flex justify-between items-center">
                            <span class="bg-blue-50 text-blue-600 px-4 py-1 rounded-full text-xs font-black">حالة طارئة</span>
                            <span class="text-slate-400 font-bold text-sm">رقم الحالة: #4432</span>
                        </div>
                        <h1 class="text-2xl font-black text-slate-800">خالد يوسف (28 سنة)</h1>
            ...
            <div class="lg:w-2/3 space-y-8">
                <div class="bg-white p-10 rounded-[2.5rem] shadow-xl shadow-slate-200/60 border border-white relative overflow-hidden">
                    <div class="absolute top-0 right-0 p-8 opacity-5">
                        <span class="material-symbols-outlined text-[120px]">wheelchair_pickup</span>
                    </div>
                    ...
                    <p class="text-slate-600 leading-[2.2] font-medium text-lg text-justify">
                        تعرض خالد لحادث سير أليم أدى إلى إصابته بكسور مضاعفة أثرت على حركته بشكل مؤقت. خالد كان المعيل الوحيد لأسرته قبل الحادث، والآن يحتاج إلى برنامج علاج طبيعي مكثف لمدة 6 أشهر ليستعيد قدرته على المشي والعودة لعمله مرة أخرى. مساعدتكم ستساهم في دفع تكاليف الجلسات الطبية والمستلزمات العلاجية.
                    </p>

                    <div class="mt-12 p-8 bg-slate-50 rounded-3xl border border-slate-100">
                        <div class="flex justify-between items-end mb-4">
                            <div>
                                <p class="text-slate-400 font-bold text-xs uppercase tracking-widest mb-1">تكلفة العلاج</p>
                                <p class="text-3xl font-black text-slate-800">12,000 <span class="text-sm">ج.م</span></p>
                            </div>
                            <div class="text-left">
                                <p class="text-blue-600 font-black text-xl">50%</p>
                                <p class="text-slate-400 font-bold text-[10px]">تم جمع 6,000 ج.م</p>
                            </div>
                        </div>
                        <div class="w-full bg-slate-200 rounded-full h-4 overflow-hidden">
                            <div class="progress-gradient h-full rounded-full shadow-lg shadow-blue-500/40" style="width: 50%"></div>
                        </div>
                    </div>

                    <div class="mt-10 flex flex-col sm:flex-row gap-4">
                        <a href="donation.html" class="flex-1 bg-blue-700 hover:bg-blue-800 text-white py-5 rounded-2xl font-black text-lg shadow-2xl shadow-blue-700/30 transition-all active:scale-[0.98] flex items-center justify-center gap-3">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <div class="bg-white p-6 rounded-3xl border border-slate-100 flex items-center gap-5">
                        <div class="w-14 h-14 bg-blue-50 text-blue-600 rounded-2xl flex-shrink-0 flex items-center justify-center">
                            <span class="material-symbols-outlined text-2xl">fitness_center</span>
                        </div>
                        <div class="min-w-0">
                            <p class="font-black text-slate-800 text-sm md:text-base">علاج طبيعي</p>
                            <p class="text-[10px] text-slate-400 font-bold truncate">جلسات تأهيل حركي</p>
                        </div>
                    </div>
                    <div class="bg-white p-6 rounded-3xl border border-slate-100 flex items-center gap-5">
                        <div class="w-14 h-14 bg-red-50 text-red-600 rounded-2xl flex-shrink-0 flex items-center justify-center">
                            <span class="material-symbols-outlined text-2xl">medication</span>
                        </div>
                        <div class="min-w-0">
                            <p class="font-black text-slate-800 text-sm md:text-base">أدوية دعم</p>
                            <p class="text-[10px] text-slate-400 font-bold truncate">مضادات التهاب وفيتامينات</p>
                        </div>
                    </div>
                </div>
            </div>
        ...
        function shareCase() {
            if (navigator.share) {
                navigator.share({
                    ...
                    text: 'خالد يحتاج دعمكم للعودة للمشي مرة أخرى. ساهم في نشره!',
                    url: window.location.href
                });
            } else {
                alert('تم نسخ رابط الحالة! يمكنك الآن لصقه في أي مكان ومشاركته. 🔗');
